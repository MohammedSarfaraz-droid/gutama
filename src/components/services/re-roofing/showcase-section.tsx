            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <article>
                <div className="relative h-52 overflow-hidden rounded-lg border border-border/40">
                  <Image src="/images/before-roof.jpg" alt="Re-roofing before" fill className="object-cover" sizes="(max-width: 640px) 100vw, 50vw" />
                </div>
                <p className="mt-2 text-xs font-semibold uppercase tracking-[0.16em] text-muted-foreground">Before</p>
              </article>
              <article>
                <div className="relative h-52 overflow-hidden rounded-lg border border-border/40">
                  <Image src="/images/after-roof.jpg" alt="Re-roofing after" fill className="object-cover" sizes="(max-width: 640px) 100vw, 50vw" />
                </div>
