...
const FAQS = [
  { question: "How long does emergency repair typically take?", answer: "Timeline depends on scope, access, and weather. We provide a clear schedule before starting." },
