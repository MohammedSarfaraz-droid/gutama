  ...
  return (
    <section className="relative overflow-hidden py-24 md:py-32">
      <div className="absolute inset-0">
        <Image src="/images/service-carpentry.jpg" alt="Expert carpentry services" fill priority className="object-cover" sizes="100vw" />
      ...
      <Container className="relative">
        <Reveal className="mb-6 inline-flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <ChevronRight className="h-4 w-4" />
          <span className="text-foreground">Carpentry</span>
        </Reveal>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.45fr_1fr] lg:items-end">
          <Reveal className="max-w-3xl">
            ...
            <h1 className="mb-6 font-serif text-4xl font-bold text-foreground md:text-5xl lg:text-6xl">Expert Carpentry Services</h1>
            <p className="mb-8 max-w-2xl text-lg leading-relaxed text-muted-foreground md:text-xl">
              Skilled structural and finish carpentry for repairs and renovations.
            </p>
